...
val loginBg      = Color(0xFF000000) // Fondo negro puro

val homeBg      = Color(0xFF18181B) // Fondo negro para el home
val neonBlue     = Color(0xFF00E5FF) // Azul fluorescente principal
val neonBlueDim  = Color(0x9900E5FF) // Azul fluorescente con transparencia (bordes no enfocados)
